    ...
    <div class="h-full bg-gray-800">
        ...
        <nav>
            <ul>
                ...
                <!-- Manage Books -->
                <SideNavLink
                :href="route('manage-books')" :active="route().current('manage-books')"
                >
                ...
                <!-- Book Categories -->
                <SideNavLink
                :href="route('book-categories')" :active="route().current('book-categories')"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <!-- Book Authors -->
                <SideNavLink
                :href="route('book-authors')" :active="route().current('book-authors')"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <!-- Issued Books -->
                <SideNavLink
                :href="route('issued-books')" :active="route().current('issued-books')"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <!-- Transactions -->
                <SideNavLink
                :href="route('transactions')" :active="route().current('transactions')"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <!-- User Management -->
                <SideNavLink
                :href="route('user-management')" :active="route().current('user-management')"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
